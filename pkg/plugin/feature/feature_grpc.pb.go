...
const (
	Plugin_GetName_FullMethodName         = "/plugins.feature.Plugin/GetName"
	Plugin_GetUIName_FullMethodName       = "/plugins.feature.Plugin/GetUIName"
	Plugin_GetSurvey_FullMethodName       = "/plugins.feature.Plugin/GetSurvey"
	Plugin_ValidateAnswers_FullMethodName = "/plugins.feature.Plugin/ValidateAnswers"
	Plugin_Stop_FullMethodName            = "/plugins.feature.Plugin/Stop"
)
...
type PluginClient interface {
	...
	GetUIName(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetUINameResponse, error)
...
func (c *pluginClient) GetUIName(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetUINameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUINameResponse)
	err := c.cc.Invoke(ctx, Plugin_GetUIName_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PluginServer interface {
	...
	GetUIName(context.Context, *Empty) (*GetUINameResponse, error)
...
func (UnimplementedPluginServer) GetUIName(context.Context, *Empty) (*GetUINameResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUIName not implemented")
}
...
func _Plugin_GetUIName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PluginServer).GetUIName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Plugin_GetUIName_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PluginServer).GetUIName(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Plugin_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "plugins.feature.Plugin",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetUIName",
			Handler:    _Plugin_GetUIName_Handler,
		},
		{
	...
	Metadata: "plugin/feature/feature.proto",
}
